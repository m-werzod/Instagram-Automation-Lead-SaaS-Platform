...
export const AuditActions = {
  ...
  GRANTED_ACCOUNT_ACCESS: "GRANTED_ACCOUNT_ACCESS",
  ASSIGNED_LEAD: "ASSIGNED_LEAD",
  AI_QUALIFIED_LEAD: "AI_QUALIFIED_LEAD",
  PERMISSION_FAILURE: "PERMISSION_FAILURE",
  META_API_FAILURE: "META_API_FAILURE",
  ...
  SAVED_LEAD_BUTTON: "SAVED_LEAD_BUTTON",
  ...
  UPLOADED_COMMENT_RESOURCE: "UPLOADED_COMMENT_RESOURCE",
  DELETED_COMMENT_RESOURCE: "DELETED_COMMENT_RESOURCE",
  ...
  CREATED_VIDEO_PROJECT: "CREATED_VIDEO_PROJECT",
  DELETED_VIDEO_PROJECT: "DELETED_VIDEO_PROJECT",
  UPDATED_VIDEO_PROJECT: "UPDATED_VIDEO_PROJECT",
  UPLOADED_VIDEO_ASSET: "UPLOADED_VIDEO_ASSET",
  DELETED_VIDEO_ASSET: "DELETED_VIDEO_ASSET",
  STARTED_VIDEO_RENDER: "STARTED_VIDEO_RENDER",
